      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex space-x-8 items-center">
            ...
            <span className="text-gray-600 cursor-not-allowed flex items-center px-2 py-1" title="Coming Soon">
              Machine
            ...
            <a
              ...
              className="text-gray-300 hover:text-indigo-400 px-2 py-1 rounded-md flex items-center"
            >
        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <span className="text-gray-600 cursor-not-allowed flex items-center px-3 py-2" title="Coming Soon">
              Machine
              <svg className="w-4 h-4 ml-1" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
              </svg>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-300 hover:text-indigo-400 flex items-center px-3 py-2 rounded-md text-base font-medium"
            >
