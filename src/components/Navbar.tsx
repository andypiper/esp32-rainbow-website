      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden min-[1000px]:flex space-x-8 items-center" role="menubar">
            ...
            <Link to="/firmware" className="text-gray-300 hover:text-indigo-400 focus:ring-2 focus:ring-indigo-500 focus:outline-none rounded-md px-3 py-2" role="menuitem">
              Firmware
            </Link>
